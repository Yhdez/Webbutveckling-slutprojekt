...
"Hush","The Darkness","	The Purge: Election Year","Viral","In a Valley of Violence","Incarnate","The Resurrection of Gavin Stone","Get Out","The Belko Experiment","Sleight","Lowriders","Birth of the Dragon","Happy Death Day","Creep 2","Amityville: The Awakening",
"Like. Share. Follow.","Totem","Insidious: The Last Key","Stephanie","Family Blood","Delirium","Upgrade","The First Purge","Unfriended: Dark Web","The Keeping Hours","	BlacKkKlansman","Seven in Heavens","Cam","Glass","Happy Death Day 2U","Mercy Black",
,"Ma","Don't Let Go","Bloodline","The Gallows Act II","Adopt a Highway","The Invisible Man","You Should Have Left","Evil Eye","Nocturne","The Craft: Legacy","The Vigil","The Forever Purge","This Is the Night","Bingo Hell","Black as Night	","Madres","The Manor","Halloween Kills",
        ...
        async function Create_results(Resultat){
          ...
          for(let object = 0; object < Resultat.length; object++){
            if(See_if_title_is_made_by_blumhouse(Resultat[object]) === true){
              ...
              Lista_av_Titlar_resultat[(Lista_av_Titlar_resultat.length) -1].onclick = function(){ //Ser ifall en titel är tryckt
          ...
          if (Resultat_div.innerHTML === ''){
            ...
            console.log("Kunde inte hitta titel")
          }
          } 
    }
}
...
function Show_information_on_result(Resultat){
  ...
  `<div id="Information_om_titel_bakgrund"><div><img src="${'https://image.tmdb.org/t/p/w500' + Resultat.poster_path}"id="Information_bild_bredvid_text" alt="${Resultat.original_title} Bild" loading="lazy"></div>
