...
"Like. Share. Follow.","Insidious: The Last Key","Stephanie","Family Blood","Delirium","Upgrade","The First Purge","Unfriended: Dark Web","The Keeping Hours","	BlacKkKlansman","Seven in Heavens","Cam","Glass","Happy Death Day 2U","Mercy Black",
        ...
        async function Create_results(Resultat){
          ...
          for(let object = 0; object < Resultat.length; object++){
            if(See_if_title_is_made_by_blumhouse(Resultat[object]) === true){
              ...
              Lista_av_Titlar_resultat[(Lista_av_Titlar_resultat.length) -1].onclick = function(){ //Lägger till en funktion för ifall den särskilda titeln är tryckt
